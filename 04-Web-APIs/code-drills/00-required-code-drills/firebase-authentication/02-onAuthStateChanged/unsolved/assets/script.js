...
// First we need to create an event listener using firebase
// To do that, we will need to reference: https://firebase.google.com/docs/auth/web/manage-users#get_the_currently_signed-in_user

// ...then we need to check if the user is signed in

// if the user is signed in, we should run the function grantAccess()

// else... we should run the function removeAccess()
...
function grantAccess() {
  // get currentUser information from firebase auth
